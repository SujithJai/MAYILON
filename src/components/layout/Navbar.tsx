          ...
          <div className="shell flex h-[66px] sm:h-[74px] items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              <button
                ...
                className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition-all duration-300 hover:border-red-600 hover:text-red-600 shrink-0"
              >
                <Search size={16} />
              </button>
              <a
                ...
                className="hidden h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition-all duration-300 hover:border-red-600 hover:text-red-600 sm:flex shrink-0"
              >
                <Phone size={16} />
              </a>
              ...
              <button
                ...
                className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition lg:hidden shrink-0"
              >
